FROM    hasura/graphql-engine:v1.0.0-beta.5.cli-migrations
...
LABEL   org.label-schema.vcs-url = "https://github.com/lavrahq/response-data"
LABEL   org.label-schema.vendor = "Lavra"
LABEL   org.label-schema.schema-version = "1.0"
LABEL   io.lavra.stack.supported = "true"

COPY    migrations /cli-migrations
